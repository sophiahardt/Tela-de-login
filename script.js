...
document.getElementById("toggle").onclick = () => {
    ...
    document.getElementById("toggle").innerHTML = cadastro "Já tem conta? Faça Login!" : "Não tem conta? Cadastre-se!";
...
document.getElementById("form-login").onsubmit = (e) => {
    ...
    if (cadastro) {
        ...
        mensagem.innerHTML = "<div class='sucesso'><p> Cadastrado co sucesso!</p></div>";
    } else {
